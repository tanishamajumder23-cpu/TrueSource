    ...
    <div className="app">
          ...
          <>
            <section className="hero">
              ...
              <p className="hero__tagline">
                Text, links, screenshots or video — Veristate splits it into individual claims, retrieves real
      ...
      <footer className="footer">
        <div className="container footer__inner">
          <span>Veristate · verdicts are grounded in retrieved evidence, never model memory.</span>
