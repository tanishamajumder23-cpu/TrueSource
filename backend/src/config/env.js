 ...
 *
 * Design note: nothing here throws. Veristate is built to degrade gracefully —
...
const config = {
  ...
  database: {
    ...
    name: process.env.PGDATABASE || 'veristate',
  ...
  telegram: {
    ...
    apiBaseUrl: process.env.VERISTATE_API_URL || 'http://localhost:3000',
  },
};
