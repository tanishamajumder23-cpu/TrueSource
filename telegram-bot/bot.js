  ...
  try {
    ...
    const message =
      ...
      (error.code === 'ECONNREFUSED'
        ? `I can't reach the Veristate API at ${API}. Is the backend running?`
...
bot.onText(/^\/start/, (msg) => {
  bot.sendMessage(
    msg.chat.id,
    [
      '*Veristate* — fact\\-check anything, right here in chat\\.',
      '',
      'Send me:',
...
log.info(`Veristate Telegram bot is running. Talking to the API at ${API}`);
